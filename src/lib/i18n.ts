...
const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    'clients.horaires': 'Horaires',
    'clients.total_assigned': 'Total affectes',
    'clients.competences_requises': 'Competences requises',
    'clients.certifications_requises': 'Certifications requises',
    'clients.aucune_langue': 'Aucune langue requise',
    'clients.aucune_competence': 'Aucune competence requise',
    'clients.titulaires': 'Titulaires',
    'clients.stand_by_label': 'Stand-by',
    'clients.en_formation_label': 'En formation',
    'clients.aucun_titulaire': 'Aucun titulaire affecte',
    'clients.aucun_stand_by': 'Aucun stand-by affecte',
    'clients.aucun_en_formation': 'Aucun employe en formation',
    'clients.find_replacement': 'Trouver un remplacant',
  ...
  en: {
    ...
    'clients.horaires': 'Schedule',
    'clients.total_assigned': 'Total assigned',
    'clients.competences_requises': 'Required skills',
    'clients.certifications_requises': 'Required certifications',
    'clients.aucune_langue': 'No required languages',
    'clients.aucune_competence': 'No required skills',
    'clients.titulaires': 'Assigned staff',
    'clients.stand_by_label': 'Stand-by',
    'clients.en_formation_label': 'In training',
    'clients.aucun_titulaire': 'No assigned staff',
    'clients.aucun_stand_by': 'No stand-by staff',
    'clients.aucun_en_formation': 'No employees in training',
    'clients.find_replacement': 'Find replacement',
